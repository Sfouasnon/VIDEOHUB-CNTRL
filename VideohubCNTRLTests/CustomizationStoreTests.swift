...
struct CustomizationStoreTests {
    ...
    func failedSaveRollsBackInMemoryCustomization() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("VideohubCNTRL-UnwritableStore-\(UUID().uuidString)")
    ...
    private func temporaryStoreURL() -> URL {
        FileManager.default.temporaryDirectory
            .appendingPathComponent("VideohubCNTRL-CustomizationTests-\(UUID().uuidString)", isDirectory: true)
